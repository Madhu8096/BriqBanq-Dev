...
import {
    ...
    FileCheck, ExternalLink, ChevronRight, Home
} from "lucide-react";
    ...
    return (
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 animate-fade-in relative z-10 w-full min-h-screen">
            ...
            <div className="bg-white/60 backdrop-blur-md p-4 rounded-xl border border-gray-100 flex flex-col lg:flex-row gap-4 shadow-sm items-center mb-6">
                <div className="flex-1 relative w-full font-sans">
                    <input
                        type="text"
            ...
            <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-[#2D31A6]/5 p-6 rounded-2xl border border-[#2D31A6]/10 flex gap-4">
                    <div className="w-12 h-12 bg-[#2D31A6] text-white rounded-xl flex items-center justify-center flex-shrink-0 shadow-lg shadow-indigo-100">
                        <Shield size={24} />
                    </div>
                    <div>
...
function StatCard({ label, value, subtext, icon, color }) {
    const colorMap = {
        indigo: "bg-[#4F46E5]/10 text-[#4F46E5] border-[#4F46E5]/20 shadow-indigo-100/50",
    ...
    return (
        <div className="bg-white p-6 rounded-[22px] border border-slate-100 shadow-sm flex items-start justify-between group hover:border-[#4F46E5]/30 hover:shadow-xl hover:shadow-indigo-500/5 transition-all duration-500 font-sans relative overflow-hidden h-32">
