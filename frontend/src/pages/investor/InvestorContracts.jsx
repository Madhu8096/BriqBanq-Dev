    ...
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        ...
        <button
          ...
          className="bg-[#4F46E5] hover:bg-[#4338CA] text-white text-xs font-black uppercase tracking-widest px-6 py-3.5 rounded-xl inline-flex items-center gap-2 transition-all active:scale-95 shadow-xl shadow-indigo-100 group"
        >
                    ...
                    {photoPreviews.length > 0 && (
                      <div className="flex gap-2 flex-wrap pb-4">
                        {(photoPreviews || []).map((preview, index) => (
                          <div key={index} className="relative w-20 h-20 rounded shadow-sm border border-slate-200 overflow-hidden">
                            <img
                              src={preview}
