        ...
        <div className="min-h-screen bg-[#F8FAFC] pb-20">
            ...
            <div className="max-w-[1200px] mx-auto px-8 mt-10">
                ...
                <div className="flex items-center justify-between mb-8">
                    <div>
                        <h2 className="text-4xl font-black text-gray-900 tracking-tight">Integration Architecture</h2>
                    ...
                    <div className="p-8">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
                            <div className="p-6 rounded-2xl bg-blue-50/50 border border-blue-100">
                                <div className="flex items-center gap-2 mb-3">
                                    ...
                                    <h4 className="font-black text-sm uppercase tracking-wider text-blue-900">Shared Services</h4>
                                </div>
                            ...
                            <div className="p-6 rounded-2xl bg-purple-50/50 border border-purple-100">
                                <div className="flex items-center gap-2 mb-3">
                                    ...
                                    <h4 className="font-black text-sm uppercase tracking-wider text-purple-900">Opt-In Model</h4>
                                </div>
                            ...
                            <div className="p-6 rounded-2xl bg-emerald-50/50 border border-emerald-100">
                                <div className="flex items-center gap-2 mb-3">
                                    ...
                                    <h4 className="font-black text-sm uppercase tracking-wider text-emerald-900">Data Unification</h4>
                                </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                ...
                                <ul className="space-y-4">
                                    {[
                                        ...
                                        <li key={i} className="flex gap-3 text-sm text-gray-600 font-medium">
                                            <span className="w-5 h-5 flex-shrink-0 bg-gray-200 rounded-full flex items-center justify-center text-[10px] text-gray-500">✕</span>
                                            {text}
                                        </li>
                                    ))}
                                </ul>
                            ...
                            <div className="bg-emerald-50/40 rounded-2xl p-8 border border-emerald-200/50 relative overflow-hidden">
                                ...
                                <h4 className="text-emerald-900 font-black text-lg mb-6 flex items-center gap-2">
                                ...
                                <ul className="space-y-4 relative z-10">
                                    {[
                                        ...
                                        <li key={i} className="flex gap-3 text-sm text-emerald-800 font-medium">
                                            <div className="w-5 h-5 flex-shrink-0 bg-emerald-500 rounded-full flex items-center justify-center text-[10px] text-white">✓</div>
                                            {text}
                                        </li>
                                    ))}
                                </ul>
                ...
                {/* Core Add-On Modules */}
                <div className="mb-16">
                    <h3 className="text-2xl font-black text-gray-900 mb-8">Core Add-On Modules</h3>
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                        {coreModules.map((module) => (
                            <div key={module.name} className="bg-white p-6 rounded-2xl border border-gray-200 hover:shadow-lg transition-all group flex flex-col items-center text-center">
                                ...
                                <h4 className="font-extrabold text-gray-900 text-sm mb-1">{module.name}</h4>
                ...
                {/* Specialized Modules */}
                <div className="mb-16">
                    <h3 className="text-2xl font-black text-gray-900 mb-2">Specialized Modules</h3>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                        {specializedModules.map((module) => (
                            <div key={module.name} className="bg-white p-6 rounded-2xl border border-gray-200 hover:border-indigo-300 hover:shadow-md transition-all group">
                                ...
                                <h4 className="font-extrabold text-gray-800 text-sm mb-1">{module.name}</h4>
                                <p className="text-xs text-gray-500 font-medium">{module.desc}</p>
                            </div>
                        ))}
                    </div>
                    ...
                    <div className="p-8 md:p-12">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
                            ...
                            <div className="lg:col-span-7">
                                <h4 className="text-lg font-black text-gray-900 mb-6 uppercase tracking-wider border-b border-gray-100 pb-4">Specialized Modules</h4>
                                <div className="bg-gray-50 rounded-3xl p-8 border border-gray-100 relative overflow-hidden group">
                                    ...
                                    <div className="flex justify-between items-start mb-8 relative z-10">
                                        <div>
                                            <p className="text-xl font-extrabold text-gray-900">Base Price</p>
                                            <p className="text-gray-500 text-sm mt-1">Per module, per month</p>
                                        </div>
                                        <div className="text-right">
                                            <p className="text-4xl font-black text-indigo-600">$199</p>
                                        </div>
                                    </div>
                                    <div className="space-y-4 relative z-10">
                                        <p className="text-sm font-black text-gray-400 uppercase tracking-widest">Includes:</p>
                            ...
                            <div className="lg:col-span-5">
                                <h4 className="text-lg font-black text-gray-900 mb-6 uppercase tracking-wider border-b border-gray-100 pb-4">Core Add-On Modules</h4>
                                        ...
                                        <div key={item.name} className={`bg-white border hover:border-gray-300 transition-all rounded-2xl p-5 shadow-sm`}>
                                            ...
                                            <ul className="space-y-2">
                                                {item.items.map((line, i) => (
                                                    <li key={i} className="flex gap-2 text-[11px] font-bold text-gray-500">
                        ...
                        <div className="mt-16 bg-emerald-50/50 rounded-3xl border border-emerald-100 p-8">
                            <h4 className="text-emerald-900 font-extrabold text-base mb-8 flex items-center gap-2">
                                <Zap className="w-5 h-5" />
                                Example Bundle Pricing
                            </h4>
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
                                <div>
                                    <p className="text-sm font-black text-emerald-900 uppercase tracking-wider mb-2">Small Practice</p>
                                    <p className="text-xs text-emerald-700/70 font-bold mb-4">Grow Accounting + Grow CRM</p>
                                    <p className="text-2xl font-black text-indigo-600">$298/month</p>
                                </div>
                                <div className="border-l-0 md:border-l border-emerald-200 pl-0 md:pl-12">
                                    <p className="text-sm font-black text-emerald-900 uppercase tracking-wider mb-2">Mid-Size Firm</p>
                                    <p className="text-xs text-emerald-700/70 font-bold mb-4">3 modules + all add-ons</p>
                                    <p className="text-2xl font-black text-indigo-600">$974/month</p>
                                </div>
                                <div className="border-l-0 md:border-l border-emerald-200 pl-0 md:pl-12">
                                    <p className="text-sm font-black text-emerald-900 uppercase tracking-wider mb-2">Enterprise</p>
                                    <p className="text-xs text-emerald-700/70 font-bold mb-4">All 11 modules + add-ons</p>
                                    <p className="text-2xl font-black text-indigo-600">$2,566/month</p>
                                </div>
                            </div>
                        </div>
                    </div>
