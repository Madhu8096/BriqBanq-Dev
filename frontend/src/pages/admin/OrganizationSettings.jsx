        ...
        <div className="space-y-8 max-w-7xl pb-20">
            ...
            <div className="bg-white rounded-3xl border border-gray-100 p-8 shadow-sm">
                <div className="flex items-center gap-4 mb-8">
                    ...
                    <div>
                        <h3 className="text-sm font-black text-gray-900 uppercase tracking-widest">Organization Details</h3>
                        <p className="text-[10px] text-gray-400 font-bold uppercase tracking-widest mt-0.5">Manage your organization information</p>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-2">
                        <label className="text-[10px] font-black text-gray-400 uppercase tracking-widest ml-1">ABN *</label>
                        <input
                            type="text"
                            name="abn"
                            value={orgData.abn}
                    ...
                    <div className="space-y-2">
                        <label className="text-[10px] font-black text-gray-400 uppercase tracking-widest ml-1">Company Size</label>
                        <select
                            name="size"
                            value={orgData.size}
                            onChange={handleChange}
            ...
            <div className="bg-white rounded-3xl border border-gray-100 p-8 shadow-sm">
                <div className="flex items-center justify-between mb-8">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h3 className="text-sm font-black text-gray-900 uppercase tracking-widest">Team Members ({members.length})</h3>
                            <p className="text-[10px] text-gray-400 font-bold uppercase tracking-widest mt-0.5">Manage who has access to your organization</p>
                        </div>
                    </div>
                    <button className="flex items-center gap-2 px-6 py-2.5 bg-indigo-600 text-white rounded-xl text-[10px] font-black uppercase tracking-widest hover:bg-indigo-700 transition-all shadow-lg shadow-indigo-100">
                        ...
                        <div key={member.id} className="flex items-center justify-between p-4 bg-gray-50/50 border border-gray-100 rounded-2xl group hover:bg-white hover:shadow-md transition-all duration-300">
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-[10px] text-gray-400 font-bold tracking-tight">{member.email}</p>
                                </div>
                            </div>
                            <div className="flex items-center gap-4">
                                <select className="bg-white border border-gray-200 rounded-lg px-3 py-1.5 text-[10px] font-black uppercase tracking-widest text-gray-600 focus:outline-none focus:ring-2 focus:ring-indigo-50">
                ...
                <div className="mt-8 p-6 bg-indigo-50/50 rounded-2xl border border-indigo-100/50">
                    <p className="text-[11px] font-black text-indigo-600 uppercase tracking-widest mb-3">Team Member Roles:</p>
                    <ul className="space-y-2">
                        <li className="flex items-start gap-2 text-[10px] text-gray-600 font-bold uppercase tracking-tight">
            ...
            <div className="bg-white rounded-3xl border border-gray-100 p-8 shadow-sm">
                <div className="flex items-center gap-4 mb-8">
                    ...
                    <div>
                        <h3 className="text-sm font-black text-gray-900 uppercase tracking-widest">Billing Information</h3>
                        <p className="text-[10px] text-gray-400 font-bold uppercase tracking-widest mt-0.5">Subscription and payment details</p>
                    </div>
                </div>
                ...
                <div className="space-y-4">
                    ...
                    <div className="p-6 bg-indigo-50/20 border border-indigo-100/50 rounded-2xl flex items-center justify-between">
                        <div>
                            <p className="text-lg font-black text-gray-900 tracking-tight">Professional Plan</p>
                            <p className="text-[10px] text-gray-500 font-black uppercase tracking-widest mt-1">A$299/month • Billed annually</p>
                            <p className="text-[9px] text-gray-400 font-bold uppercase tracking-widest mt-2">Next billing date: 1 March 2026</p>
                        </div>
                        <button className="px-6 py-2.5 bg-white border border-gray-200 rounded-xl text-[10px] font-black uppercase tracking-widest text-gray-900 hover:bg-gray-50 transition-all shadow-sm">
                            Manage Plan
                        </button>
                    </div>
                    ...
                    <div className="p-6 bg-gray-50/50 border border-gray-100 rounded-2xl flex items-center justify-between">
                        <div className="flex items-center gap-4">
                            <div className="w-12 h-8 bg-white border border-gray-100 rounded flex items-center justify-center">
                                <span className="text-[10px] font-black text-gray-400 italic">VISA</span>
                            </div>
                            <div>
                                <p className="text-sm font-black text-gray-900 tracking-widest">•••• •••• •••• 4242</p>
                                <p className="text-[9px] text-gray-400 font-bold uppercase tracking-widest mt-1">Expires 12/2025</p>
                            </div>
                        </div>
                        <button className="flex items-center gap-2 px-6 py-2.5 bg-white border border-gray-200 rounded-xl text-[10px] font-black uppercase tracking-widest text-gray-900 hover:bg-gray-50 transition-all shadow-sm">
                    ...
                    <div className="p-4 bg-amber-50/50 border border-amber-100/50 rounded-xl flex items-center gap-3">
                        ...
                        <div>
                            <p className="text-[11px] font-black text-amber-700 uppercase tracking-widest">Billing Contact</p>
                            <p className="text-[10px] text-amber-600 font-bold tracking-tight">All invoices will be sent to the organization administrator email.</p>
                        </div>
                    </div>
                </div>
            </div>
