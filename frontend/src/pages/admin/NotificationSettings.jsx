    ...
    const Toggle = ({ checked, onChange, label, sub }) => (
        <div className="flex items-center justify-between py-4 group">
            <div className="flex-1">
                ...
                {sub && <p className="text-[10px] text-gray-400 font-bold uppercase tracking-widest mt-0.5">{sub}</p>}
            </div>
            <button
                onClick={onChange}
        ...
        <div className="space-y-8 max-w-7xl pb-20">
            ...
            <div className="flex flex-col gap-6">
                ...
                <button
                    ...
                    className="flex items-center gap-2 px-4 py-2 w-fit bg-white border border-gray-100 rounded-xl text-[10px] font-black uppercase tracking-widest text-gray-500 hover:text-gray-900 hover:bg-gray-50 transition-all shadow-sm"
                >
            ...
            <div className="space-y-6">
                ...
                <div className="bg-white rounded-3xl border border-gray-100 p-8 shadow-sm">
                    <div className="flex items-center gap-4 mb-8">
                        ...
                        <div>
                            <h3 className="text-sm font-black text-gray-900 uppercase tracking-widest">Email Notifications</h3>
                            <p className="text-[10px] text-gray-400 font-bold uppercase tracking-widest mt-0.5">Manage which emails you receive from us</p>
                        </div>
                    </div>
                ...
                <div className="bg-white rounded-3xl border border-gray-100 p-8 shadow-sm">
                    <div className="flex items-center gap-4 mb-8">
                        ...
                        <div>
                            <h3 className="text-sm font-black text-gray-900 uppercase tracking-widest">Push Notifications</h3>
                            <p className="text-[10px] text-gray-400 font-bold uppercase tracking-widest mt-0.5">In-app and browser notifications</p>
                        </div>
                    </div>
                ...
                <div className="bg-white rounded-3xl border border-gray-100 p-8 shadow-sm">
                    <div className="flex items-center gap-4 mb-8">
                        ...
                        <div>
                            <h3 className="text-sm font-black text-gray-900 uppercase tracking-widest">SMS Notifications</h3>
                            <p className="text-[10px] text-gray-400 font-bold uppercase tracking-widest mt-0.5">Text message alerts to your phone</p>
                        </div>
                    </div>
                    ...
                    <div className="mt-8 p-4 bg-amber-50/50 border border-amber-100 rounded-xl flex items-center gap-3">
                        ...
                        <p className="text-[11px] text-amber-900 font-black uppercase tracking-widest">
            ...
            <div className="flex items-center justify-end gap-4 pt-4 border-t border-gray-100">
                <button
                    onClick={() => navigate('/admin/settings')}
                    className="px-8 py-3 bg-white border border-gray-100 rounded-xl text-xs font-black uppercase tracking-widest text-gray-500 hover:text-gray-900 hover:bg-gray-50 transition-all shadow-sm"
                >
                    Cancel
                </button>
                <button
                    onClick={handleSave}
                    disabled={isSaving}
                    className="flex items-center gap-3 px-10 py-3 bg-indigo-700 text-white rounded-xl text-xs font-black uppercase tracking-widest shadow-lg shadow-indigo-100 hover:bg-indigo-800 hover:-translate-y-0.5 transition-all disabled:opacity-50 group"
                >
                    {isSaving ? (
                        <>
