                                ...
                                <div className="w-full max-w-2xl aspect-[1/1.414] bg-white rounded shadow-lg border border-gray-200 flex flex-col items-center justify-center relative overflow-hidden group">
                                    <div className="flex flex-col items-center gap-4 text-gray-400 transition-all duration-300 group-hover:scale-105">
                                        ...
                                        <div className="text-center">
                                            <p className="text-lg font-black text-gray-900">PDF Viewer</p>
                                    ...
                                    <div className="absolute top-0 right-0 p-4">
                                        <div className="w-8 h-8 rounded bg-gray-100 flex items-center justify-center text-[10px] font-black">PDF</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="lg:col-span-4 space-y-6">
                        ...
                        <div className="bg-white rounded-2xl border border-gray-200 p-8 shadow-sm">
                            ...
                            <div className="space-y-6">
                                <div>
                                    <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-1.5">Deal ID</p>
                                    <p className="text-sm font-black text-gray-900">MIP-2026-001</p>
                                </div>
                                <div>
                                    <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-1.5">Property</p>
                                    <p className="text-sm font-black text-gray-900 leading-snug">45 Victoria Street, Potts Point, NSW</p>
                                </div>
                                <div>
                                    <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-1.5">Borrower</p>
                                    <p className="text-sm font-bold text-gray-700">Sarah Mitchell</p>
                                </div>
                                <div>
                                    <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-1.5">Lender</p>
                                    <p className="text-sm font-bold text-gray-700">Commonwealth Bank</p>
                                </div>
                                <div>
                                    <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-1.5">Loan Amount</p>
                                    <p className="text-lg font-black text-indigo-600">A$980,000</p>
                                </div>
                                <div>
                        ...
                        <div className="space-y-3">
                            <button className="w-full py-4 bg-indigo-600 text-white rounded-xl font-black text-sm hover:bg-indigo-700 transition-all shadow-lg shadow-indigo-200 flex items-center justify-center gap-2 group">
                                <PenTool className="w-4 h-4 transition-transform group-hover:-rotate-12" />
                                Sign Contract
                            </button>
                            <button className="w-full py-4 bg-white border border-gray-200 text-gray-700 rounded-xl font-black text-sm hover:bg-gray-50 transition-all flex items-center justify-center gap-2">
                                <Download className="w-4 h-4" />
                                Download PDF
                            </button>
                            <Link to="/admin/contracts" className="w-full py-3.5 bg-indigo-50 text-indigo-600 rounded-xl font-black text-sm hover:bg-indigo-100 transition-all flex items-center justify-center gap-2">
                        ...
                        <div className="bg-white rounded-2xl border border-gray-200 p-8 shadow-sm">
                            ...
                            <div className="p-4 bg-blue-50/50 border border-blue-100 rounded-xl flex gap-3 mb-6">
                                ...
                                <div>
                                    <p className="text-xs font-black text-blue-900 uppercase tracking-tighter mb-1">Legal Binding Agreement</p>
                                    <p className="text-[11px] text-blue-800 leading-relaxed font-medium">By signing this contract, you agree to all terms and conditions outlined in the document.</p>
                                </div>
                            </div>
                            <ul className="space-y-4">
                                {[
                                    ...
                                    <li key={i} className="flex gap-2.5 text-[11px] font-bold text-gray-500">
                        ...
                        <div className="bg-orange-50/50 rounded-2xl border border-orange-100 p-8 shadow-sm">
                            <h3 className="text-orange-900 font-extrabold text-sm mb-6 uppercase tracking-widest">Before You Sign</h3>
