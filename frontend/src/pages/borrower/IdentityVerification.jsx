        ...
        <div className="bg-white border border-gray-200 rounded-lg p-6 max-w-4xl mx-auto">
          ...
          <div className="flex justify-end gap-3 mt-6">
            ...
            <button
              type="submit"
              disabled={isSubmitting}
              className="inline-flex items-center justify-center gap-2 bg-indigo-600 hover:bg-indigo-700 disabled:bg-indigo-400 disabled:cursor-not-allowed text-white text-sm font-medium px-4 py-2 rounded-lg min-w-[140px]"
            >
              {isSubmitting ? (
                <>
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-6 max-w-lg mx-auto text-center space-y-5">
          {verificationStatus === STATUS_PENDING && (
            <>
              ...
              <p className="text-lg font-semibold text-gray-900">Verification under review</p>
              <p className="text-sm text-gray-600">
                Your identity verification has been submitted. An admin will review your documents and approve your verification. You&apos;ll see this status until approval is complete.
              </p>
