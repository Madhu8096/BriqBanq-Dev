...
const defaultForm = {
  ...
  abn: MOCK_ORGANIZATION.abn,
  industry: MOCK_ORGANIZATION.industry,
  companySize: MOCK_ORGANIZATION.companySize,
  website: MOCK_ORGANIZATION.website,
  phone: MOCK_ORGANIZATION.phone,
  streetAddress: MOCK_ORGANIZATION.streetAddress,
  city: '',
  state: 'VIC',
  postcode: MOCK_ORGANIZATION.postcode,
}
...
export default function OrganizationSettings() {
  ...
  const [teamMembers, setTeamMembers] = useState([...MOCK_ORGANIZATION.teamMembers])
  ...
  const handleCancel = async () => {
    try {
      ...
      else setTeamMembers([...MOCK_ORGANIZATION.teamMembers])
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg border border-slate-200 p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <FormInput label="Organization Name" required value={formData.name} onChange={(e) => handleChange('name', e.target.value)} placeholder="Your organization name" />
          <FormInput label="ABN" required value={formData.abn} onChange={(e) => handleChange('abn', e.target.value)} placeholder="12 345 678 901" />
          ...
          <FormInput label="Website" value={formData.website} onChange={(e) => handleChange('website', e.target.value)} placeholder="https://example.com" />
          <FormInput label="Phone Number" value={formData.phone} onChange={(e) => handleChange('phone', e.target.value)} placeholder="+61 X XXXX XXXX" />
