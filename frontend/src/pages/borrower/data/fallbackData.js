...
export const FALLBACK_NOTIFICATIONS = [
  ...
  { id: 6, type: 'payment', title: 'Payment Received', message: 'Your payment of A$1,050,000 has been received and confirmed', time: '5 days ago', isNew: false, read: true },
  { id: 7, type: 'auction', title: 'Auction Started', message: 'Auction for MIP-2024-004 has started', time: '6 days ago', isNew: false, read: true }
]
