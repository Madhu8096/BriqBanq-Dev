...
export default function LenderNotifications() {
    ...
    return (
        <div className="space-y-6 animate-fade-in pt-6 pb-6">
            {/* Header */}
            <div>
                <h1 className="text-2xl font-black text-[#0F172A] mb-0.5">Notifications</h1>
                <p className="text-[#64748B] text-[11px] font-bold uppercase tracking-wider">Manage your recovery alerts and activity</p>
            </div>
...
function StatCard({ label, value, sub, icon, iconBg }) {
    return (
        <div className="bg-white p-5 rounded-2xl border border-gray-100 shadow-sm flex justify-between items-start hover:shadow-md transition-all">
            <div>
                <p className="text-[#64748B] text-[10px] font-black mb-1.5 uppercase tracking-widest">{label}</p>
                <h2 className="text-2xl font-black text-[#0F172A] mb-0.5">{value}</h2>
                ...
                <div className="flex-1">
                    <div className="flex justify-between items-start mb-0.5">
                        <div className="flex items-center gap-2">
                            ...
                            {item.unread && (
                                <span className="bg-[#4F46E5] text-white text-[9px] font-black px-1.5 py-0.5 rounded-full uppercase">New</span>
                            )}
                        </div>
