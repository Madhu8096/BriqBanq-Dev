        ...
        <div className="space-y-6 pt-6 pb-6 animate-fade-in">
            <div className="flex items-center justify-between">
                ...
                <button
                    ...
                    className="bg-[#4F46E5] hover:bg-indigo-700 text-white text-xs font-semibold px-5 py-2.5 rounded-xl inline-flex items-center gap-2 transition-all active:scale-95 shadow-lg shadow-indigo-100/50"
                >
                    <Plus size={16} />
