    ...
    <div className="space-y-6 max-w-7xl mx-auto">
      <div className="flex flex-wrap justify-between items-start gap-4">
        ...
        <button
          ...
          className="bg-[#3474E1] hover:bg-[#2a5fc4] text-white text-sm font-medium px-4 py-2 rounded-lg"
        >
          + New Task
        </button>
      </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-3">
        ...
        >
          ...
          <div>
            <p className="text-xl font-bold text-[#2A3037]">{tasks.length}</p>
        ...
        <button
          ...
          className="bg-white border border-gray-200 rounded-lg p-3 flex items-center gap-2 text-left hover:bg-gray-50 transition-colors"
        >
          <span className="text-[#3474E1]">✓</span>
          <div>
            <p className="text-xl font-bold text-[#2A3037]">{activeTasks}</p>
        ...
        >
          ...
          <div>
            <p className="text-xl font-bold text-[#2A3037]">{dueTodayCount}</p>
        ...
        >
          <span className="text-red-500">🚩</span>
          <div>
            <p className="text-xl font-bold text-[#2A3037]">{urgentCount}</p>
        ...
        >
          <span className="text-[#3474E1]">📊</span>
          <div>
            <p className="text-xl font-bold text-[#2A3037]">{inProgressCount}</p>
        ...
        >
          ...
          <div>
            <p className="text-xl font-bold text-[#2A3037]">{completedCount}</p>
      ...
      <div className="flex flex-wrap gap-3">
        <input
          ...
          className="flex-1 min-w-[200px] border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[#3474E1]"
        />
        <select
          value={statusFilter}
      ...
      <div className="flex flex-wrap items-center gap-2">
        <button
          ...
          className={`px-3 py-1 rounded-full text-sm font-medium ${sortBy === 'dueDate' ? 'bg-[#3474E1] text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'}`}
        >
        ...
        <button
          ...
          className={`px-3 py-1 rounded-full text-sm font-medium ${sortBy === 'priority' ? 'bg-[#3474E1] text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'}`}
        >
        ...
        <button
          ...
          className={`px-3 py-1 rounded-full text-sm font-medium ${sortBy === 'status' ? 'bg-[#3474E1] text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'}`}
        >
        ...
        <button
          ...
          className={`px-3 py-1 rounded-full text-sm font-medium ${sortBy === 'created' ? 'bg-[#3474E1] text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'}`}
        >
          ...
          >
            <div className="flex flex-wrap items-start justify-between gap-2">
              <div className="flex items-start gap-3 min-w-0 flex-1">
                ...
                >
                  <span
                    className={`inline-block w-5 h-5 border-2 rounded flex items-center justify-center text-xs ${task.status === 'Completed' ? 'bg-[#3474E1] border-[#3474E1] text-white' : 'border-gray-300'}`}
                  >
                    {task.status === 'Completed' && '✓'}
                  </span>
                </button>
                <div className="min-w-0">
                  <p className={`text-sm font-medium text-[#2A3037] ${task.status === 'Completed' ? 'line-through' : ''}`}>
                    {task.title}
                  </p>
              ...
              <div className="flex flex-wrap items-center gap-2 shrink-0">
                ...
                {task.status === 'Pending' && (
                  <button
                    ...
                    className="border border-[#3474E1] text-[#3474E1] text-xs px-2 py-1 rounded-lg hover:bg-[#E6F0FF]"
                  >
                    Start Task
                  </button>
                )}
                ...
                {task.status !== 'Completed' && (
                  <button
                    ...
                    className="bg-[#3474E1] hover:bg-[#2a5fc4] text-white text-xs px-2 py-1 rounded-lg"
                  >
                    Mark Complete
                  </button>
                )}
                <button
                  ...
                  className="p-1.5 text-gray-500 hover:text-[#3474E1] hover:bg-[#E6F0FF] rounded"
        ...
        >
          <div className="bg-white rounded-lg shadow-xl max-w-lg w-full overflow-hidden">
            <div className="flex items-center justify-between px-6 py-4 border-b border-gray-200">
              <h2 id="task-modal-title" className="text-lg font-semibold text-[#2A3037]">
            ...
            <div className="px-6 py-4 space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={4}
                  className="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#3474E1] focus:border-transparent resize-y min-h-[80px]"
                />
              </div>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <select
                    ...
                    className="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm text-gray-900 focus:outline-none focus:ring-2 focus:ring-[#3474E1] bg-white"
                  >
            ...
            <div className="flex justify-end gap-2 px-6 py-4 border-t border-gray-200 bg-gray-50">
              ...
              {editingTask ? (
                <button
                  ...
                  className="inline-flex items-center gap-1.5 px-4 py-2 bg-[#3474E1] hover:bg-[#2a5fc4] disabled:opacity-50 disabled:pointer-events-none text-white text-sm font-medium rounded-lg"
                >
                  Save
                </button>
              ) : (
                <button
                  ...
                  className="inline-flex items-center gap-1.5 px-4 py-2 bg-[#3474E1] hover:bg-[#2a5fc4] text-white text-sm font-medium rounded-lg"
                >
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
