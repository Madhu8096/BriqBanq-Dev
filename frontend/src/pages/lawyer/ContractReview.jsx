...
export default function ContractReview() {
  ...
  const statusBadge = (status) => {
    const map = {
      ...
      'Under Contract': 'bg-[#EEF4FF] text-[#3474E1] ring-1 ring-[#3474E1]/30',
    ...
    <div className="space-y-6 max-w-6xl mx-auto w-full min-w-0">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        ...
        <button
          ...
          className="inline-flex items-center gap-2 px-4 py-2.5 bg-[#3474E1] hover:bg-[#2a5fc4] text-white text-sm font-semibold rounded-lg shadow-sm shadow-[#3474E1]/30 transition-colors self-start sm:self-auto"
        >
                    ...
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-1.5">
                        <button
                          ...
                          className="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-semibold text-[#3474E1] bg-[#EEF4FF] hover:bg-[#dce9ff] rounded-lg transition-colors"
                        >
                        ...
                        <button
                          ...
                          className={`inline-flex items-center justify-center w-8 h-8 rounded-lg border transition-all disabled:cursor-wait ${
                            downloadedId === row.id
                              ...
                              : 'border-gray-200 bg-white text-gray-400 hover:border-[#3474E1] hover:text-[#3474E1] hover:bg-[#EEF4FF]'
                          }`}
                        >
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6">
          ...
          >
            ...
            <div className="flex items-center justify-between px-8 py-5 border-b border-gray-100 shrink-0">
              <h2 id="create-contract-title" className="text-lg font-bold text-[#2A3037]">Create New Contract</h2>
              <button
                type="button"
            ...
            <form onSubmit={handleSubmitContract} className="flex-1 overflow-y-auto">
              <div className="px-8 py-6 space-y-5">
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`w-full border rounded-lg px-4 py-2.5 text-sm text-gray-800 bg-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#3474E1]/30 transition-colors ${formErrors.propertyAddress ? 'border-red-400' : 'border-gray-300 focus:border-[#3474E1]'}`}
                  />
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full border border-gray-300 rounded-lg px-4 py-2.5 text-sm text-gray-800 bg-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#3474E1]/30 focus:border-[#3474E1] transition-colors"
                    />
                  </div>
                  {/* Status */}
                  <div>
                    ...
                    <select
                      ...
                      className="w-full border border-gray-300 rounded-lg px-4 py-2.5 text-sm text-gray-800 bg-white focus:outline-none focus:ring-2 focus:ring-[#3474E1]/30 focus:border-[#3474E1] transition-colors"
                    >
                ...
                <div>
                  ...
                  <div className="border-2 border-dashed border-gray-200 rounded-xl p-5 bg-gray-50 hover:border-[#3474E1]/40 hover:bg-[#EEF4FF]/20 transition-colors">
                    <input
                      type="file"
                      accept="image/*"
                      multiple
                      onChange={handlePhotoChange}
                      className="w-full text-sm text-gray-500 file:mr-3 file:py-1.5 file:px-4 file:rounded-lg file:border-0 file:text-sm file:font-semibold file:bg-[#EEF4FF] file:text-[#3474E1] file:cursor-pointer hover:file:bg-[#dce9ff] cursor-pointer"
                    />
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`w-full border rounded-lg px-4 py-2.5 text-sm text-gray-800 bg-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#3474E1]/30 transition-colors ${formErrors.parties ? 'border-red-400' : 'border-gray-300 focus:border-[#3474E1]'}`}
                  />
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      inputMode="numeric"
                      className={`w-full border rounded-lg px-4 py-2.5 text-sm text-gray-800 bg-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#3474E1]/30 transition-colors ${formErrors.value ? 'border-red-400' : 'border-gray-300 focus:border-[#3474E1]'}`}
                    />
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`w-full border rounded-lg px-4 py-2.5 text-sm text-gray-800 bg-white focus:outline-none focus:ring-2 focus:ring-[#3474E1]/30 transition-colors ${formErrors.date ? 'border-red-400' : 'border-gray-300 focus:border-[#3474E1]'}`}
                  />
              ...
              <div className="flex items-center justify-end gap-3 px-8 py-4 border-t border-gray-100 bg-gray-50 shrink-0">
                ...
                <button
                  ...
                  className="inline-flex items-center gap-2 px-6 py-2.5 bg-[#3474E1] hover:bg-[#2a5fc4] text-white text-sm font-semibold rounded-lg shadow-sm shadow-[#3474E1]/25 disabled:opacity-50 transition-all"
                >
                  {createSubmitting ? (
                    <>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6">
          ...
          >
            <div className="flex items-center justify-between px-7 py-5 border-b border-gray-100 shrink-0">
              <h2 id="view-contract-title" className="text-lg font-bold text-[#2A3037]">Contract Details</h2>
              <button
                type="button"
              ...
              <button
                ...
                className={`flex-1 inline-flex items-center justify-center gap-2 py-2.5 text-sm font-semibold rounded-lg transition-all disabled:opacity-60 disabled:cursor-wait ${
                  downloadedId === viewingContract?.id
                    ...
                    : 'bg-[#3474E1] hover:bg-[#2a5fc4] text-white'
                }`}
              >
