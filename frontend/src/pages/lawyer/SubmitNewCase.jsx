    ...
    <div className="space-y-5 max-w-4xl mx-auto w-full min-w-0 pb-4">
          ...
          {STEPS.map((s, idx) => (
            <div key={s.id} className="flex items-center shrink-0">
              <div className="flex flex-col items-center">
                <div className={`w-9 h-9 rounded-full flex items-center justify-center text-sm font-semibold border-2 ${step === s.id ? 'bg-[#3474E1] border-[#3474E1] text-white' : step > s.id ? 'bg-[#E6F0FF] border-[#3474E1]/30 text-[#3474E1]' : 'bg-white border-slate-300 text-slate-500'}`}>
                ...
                <span className={`text-xs mt-1.5 whitespace-nowrap max-w-[4.5rem] text-center font-medium ${step === s.id ? 'text-[#3474E1]' : step > s.id ? 'text-[#3474E1]' : 'text-slate-500'}`}>{s.label}</span>
              </div>
              {idx < STEPS.length - 1 && (
                <div className={`w-4 sm:w-6 h-0.5 mx-0.5 mt-4 shrink-0 ${step > s.id ? 'bg-[#3474E1]/30' : 'bg-slate-200'}`} aria-hidden />
              )}
            </div>
          ))}
        </div>
            ...
            <section>
              ...
              <div className="mt-4 space-y-4">
                <div>
                  ...
                  <select value={formData.typeOfSecurity} onChange={(e) => update('typeOfSecurity', e.target.value)} className="w-full border border-slate-300 rounded-md px-3 py-2.5 text-sm text-slate-900 bg-white focus:ring-2 focus:ring-[#3474E1] focus:border-[#3474E1]">
                ...
                <div>
                  ...
                  <select value={formData.mortgagePriority} onChange={(e) => update('mortgagePriority', e.target.value)} className="w-full border border-slate-300 rounded-md px-3 py-2.5 text-sm text-slate-900 bg-white focus:ring-2 focus:ring-[#3474E1] focus:border-[#3474E1]">
          ...
          <div className="p-6 space-y-6">
            ...
            <div className="rounded-lg border border-slate-200 bg-white p-5">
              ...
              <div className="mt-4 pt-4 border-t border-slate-200 flex justify-between items-center">
                <span className="font-bold text-[#3474E1]">Total Due Today</span>
                <span className="text-xl font-bold text-[#3474E1]">A$250.00</span>
              </div>
            </div>
            ...
            <div className="rounded-lg border border-slate-200 bg-white p-5">
              ...
              <label className="mt-4 flex items-start gap-2">
                <input type="checkbox" className="rounded border-slate-300 text-[#3474E1] mt-1 shrink-0" />
        ...
        {step === 4 && (
          <div className="p-6 space-y-6">
            ...
            <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg text-sm text-blue-800 flex gap-2">
              <span className="text-[#3474E1] shrink-0" aria-hidden>ℹ</span>
            ...
            <div>
              ...
              {[
                ...
                <div key={title} className="mt-3 flex flex-wrap items-center justify-between gap-4 p-3 border border-slate-200 rounded-lg">
                  ...
                  <button type="button" className="px-3 py-1.5 bg-[#3474E1] text-white text-sm font-medium rounded-md hover:bg-[#2a5fc4] flex items-center gap-1.5 shrink-0">
            ...
            <section>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-2">
                ...
                <div>
                  ...
                  <button type="button" className="w-full mt-1 px-3 py-2 border border-slate-300 rounded-md text-sm font-medium text-slate-700 hover:bg-slate-50 flex items-center gap-2">
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12" /></svg>
                    Upload Report
                  </button>
                </div>
          ...
          <div className="p-6 space-y-6">
            ...
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-2">
                ...
                <div>
                  ...
                  <button type="button" className="mt-1 px-3 py-2 border border-slate-300 rounded-md text-sm font-medium text-slate-700 hover:bg-slate-50 flex items-center gap-2">
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12" /></svg>
                    Upload Policy
                  </button>
                </div>
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-3 mt-2">
                <button type="button" className="px-3 py-2 border border-slate-300 rounded-md text-sm font-medium text-slate-700 hover:bg-slate-50 flex items-center gap-2">
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12" /></svg>
                  Upload Title
                </button>
                <button type="button" className="px-3 py-2 border border-slate-300 rounded-md text-sm font-medium text-slate-700 hover:bg-slate-50 flex items-center gap-2">
          ...
          <div className="p-6">
            ...
            <div className="mt-4 space-y-4">
              ...
              <div className="flex items-center gap-2">
                <input type="checkbox" className="rounded border-slate-300 text-[#3474E1]" />
      ...
      <div className="bg-white border border-slate-200 rounded-lg px-4 py-4 flex flex-wrap items-center justify-between gap-4 mt-6">
        ...
        <button
          ...
          onClick={handleNext}
          disabled={submitting}
          className="px-4 py-2 bg-[#3474E1] text-white text-sm font-medium rounded-md hover:bg-[#2a5fc4] disabled:opacity-50 disabled:cursor-not-allowed"
        >
