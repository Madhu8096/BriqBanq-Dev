...
const initialSubmissions = MOCK_KYC.map((s) => ({ ...s, status: s.status }))

export default function KYCReview() {
  const [submissions, setSubmissions] = useState(initialSubmissions)
  const [approvedToday, setApprovedToday] = useState(7)
  ...
  return (
    <div className="space-y-6 max-w-6xl mx-auto">
      <div>
        <h1 className="text-2xl font-bold text-[#2A3037]">KYC Review</h1>
