    ...
    const [tasks, setTasks] = useState([
        {
            ...
            priority: "Low",
            status: "Completed",
            dueDate: "Overdue (Mar 2)",
            dueDateObj: new Date('2026-03-02'),
        ...
        },
        {
            ...
            status: "In progress",
            dueDate: "Tomorrow",
            dueDateObj: new Date(new Date().setDate(new Date().getDate() + 1)),
        ...
        },
        {
            ...
            status: "Pending",
            dueDate: "Mar 6, 2026",
            dueDateObj: new Date('2026-03-06'),
        ...
        },
        {
            ...
            status: "Pending",
            dueDate: "Mar 7, 2026",
            dueDateObj: new Date('2026-03-07'),
        ...
        },
        {
            ...
            status: "Pending",
            dueDate: "Mar 9, 2026",
            dueDateObj: new Date('2026-03-09'),
        ...
        },
        {
            ...
            status: "In progress",
            dueDate: "Mar 11, 2026",
            dueDateObj: new Date('2026-03-11'),
            ...
            if (t.id === id) {
                ...
                if (newChecked) {
                    addNotification({
                        ...
                        message: `Task "${t.title}" has been marked as completed.`,
                    });
                ...
                return {
                    ...
                    checked: newChecked,
                    status: newStatus,
                    hasStartButton: !newChecked && (t.id === 3 || t.id === 5 || t.id === 6 || t.id === 7),
                    hasMoveAndMarkCompleteButtons: !newChecked && (t.id === 4 || t.id === 8)
                };
            }
            return t;
        }));
        ...
        <div className="space-y-6 animate-in fade-in duration-500 pb-12 pt-6">
            ...
            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-4">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-4">
                    <div className="relative">
                        ...
                        <div className="relative flex items-center">
                            ...
                            <input
                                ...
                                className="w-full pl-9 pr-4 py-2 text-[13px] border border-gray-200 rounded-lg focus:outline-none focus:border-[#1C4ED8] focus:ring-1 focus:ring-[#1C4ED8] transition-colors shadow-sm"
                                value={searchQuery}
                    ...
                    <div>
                        ...
                        <select
                            className="w-full px-3 py-2 text-[13px] border border-gray-200 rounded-lg focus:outline-none focus:border-[#1C4ED8] focus:ring-1 focus:ring-[#1C4ED8] transition-colors bg-white font-medium shadow-sm"
                            value={statusFilter}
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center gap-3">
                        ...
                        <div className="flex flex-wrap gap-1.5">
                            <button
                                ...
                                className={`px-3 py-1.5 text-[12px] font-bold rounded-md flex items-center gap-1.5 transition-all ${sortBy === 'Due Date' ? 'bg-[#2D31A6] text-white shadow-md shadow-indigo-200' : 'bg-gray-50 text-gray-600 hover:bg-gray-100'}`}
                            >
                                <Calendar size={13} /> Due Date
                            </button>
                            <button
                                onClick={() => setSortBy('Priority')}
                                className={`px-3 py-1.5 text-[12px] font-bold rounded-md flex items-center gap-1.5 transition-all ${sortBy === 'Priority' ? 'bg-[#2D31A6] text-white shadow-md shadow-indigo-200' : 'bg-transparent text-gray-600 hover:bg-gray-50'}`}
                            >
                                <Flag size={13} /> Priority
                            </button>
                            <button
                                onClick={() => setSortBy('Status')}
                                className={`px-3 py-1.5 text-[12px] font-bold rounded-md flex items-center gap-1.5 transition-all ${sortBy === 'Status' ? 'bg-[#2D31A6] text-white shadow-md shadow-indigo-200' : 'bg-transparent text-gray-600 hover:bg-gray-50'}`}
                            >
                                <CheckSquare size={13} /> Status
                            </button>
                            <button
                                onClick={() => setSortBy('Created')}
                                className={`px-3 py-1.5 text-[12px] font-bold rounded-md flex items-center gap-1.5 transition-all ${sortBy === 'Created' ? 'bg-[#2D31A6] text-white shadow-md shadow-indigo-200' : 'bg-transparent text-gray-600 hover:bg-gray-50'}`}
                            >
                        ...
                        <div className="flex flex-col md:flex-row md:items-start justify-between p-4 sm:p-5 gap-4">
                            <div className="flex items-start gap-4 flex-1">
                                <button
                                    ...
                                    className={`w-5 h-5 mt-1 rounded border flex items-center justify-center transition-colors shrink-0 ${task.checked ? 'bg-[#60A5FA] border-[#60A5FA]' : 'bg-gray-50 border-gray-300 hover:border-indigo-400'}`}
                                >
                                    {task.checked && <CheckSquare size={14} className="text-white" />}
                                </button>

                                <div className="flex-1">
                                    <h3 className={`text-[15px] sm:text-[16px] font-bold mb-1 tracking-tight ${task.checked ? 'text-gray-400 line-through font-semibold' : 'text-[#1E293B]'}`}>
                                        {task.title}
                                    </h3>
                                    ...
                                    <div className="flex flex-wrap items-center gap-2 sm:gap-3">
                                        ...
                                        {/* Reference Badge */}
                                        {task.caseNumber && (
                                            <div className="flex items-center gap-1.5 text-[11px] sm:text-[12px] font-bold text-[#64748B] bg-gray-50 px-2 py-1 rounded border border-gray-100">
                                        ...
                                        {/* Category Badge */}
                                        <div className="flex items-center gap-1.5 text-[11px] sm:text-[12px] font-bold text-[#64748B] bg-white px-2 py-1 rounded">
                                    ...
                                    {(!task.checked && (task.hasStartButton || task.hasMoveAndMarkCompleteButtons)) && (
                                        <div className="mt-4 pt-4 border-t border-gray-50 flex flex-wrap items-center gap-2 sm:gap-3">
                                            {task.hasStartButton && (
                                                <button className="px-5 py-2 rounded-xl border border-gray-200 text-[12px] font-bold text-gray-700 bg-white hover:bg-gray-50 transition-all shadow-sm active:scale-95">
                                                    Start Task
                                                </button>
                                            )}
                                            {task.hasMoveAndMarkCompleteButtons && (
                                                <>
                                                    ...
                                                    <button
                                                        onClick={() => toggleTaskCheck(task.id)}
                                                        className="px-5 py-2 rounded-xl text-[12px] font-bold text-white bg-[#2D31A6] hover:bg-[#232685] transition-all shadow-md shadow-indigo-100 flex items-center gap-1.5 active:scale-95"
                                                    >
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/40 backdrop-blur-sm animate-in fade-in duration-200" onClick={() => setIsNewTaskModalOpen(false)}>
                    <div className="bg-white rounded-[2rem] w-full max-w-lg shadow-2xl overflow-hidden animate-in zoom-in-95 duration-200 border border-slate-100" onClick={(e) => e.stopPropagation()}>
                        <div className="px-8 py-6 flex items-center justify-between border-b border-gray-100">
                            <h2 className="text-lg font-bold text-[#0F172A]">Create New Task</h2>
                            <button
                        ...
                        <form onSubmit={handleCreateTask}>
                            ...
                            <div className="px-8 py-5 bg-gray-50 flex items-center justify-end gap-3 border-t border-gray-100">
                                ...
                                <button
                                    type="submit"
                                    className="px-8 py-2.5 text-xs font-bold text-white bg-[#2D31A6] rounded-xl hover:bg-[#232685] transition-all shadow-lg shadow-indigo-100 flex items-center gap-2 active:scale-95"
                                >
            ...
            {isEditModalOpen && editingTask && (
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/40 backdrop-blur-sm animate-in fade-in duration-200" onClick={() => setIsEditModalOpen(false)}>
                    <div className="bg-white rounded-[2rem] w-full max-w-lg shadow-2xl overflow-hidden animate-in zoom-in-95 duration-200 border border-slate-100" onClick={(e) => e.stopPropagation()}>
                        <div className="px-8 py-6 flex items-center justify-between border-b border-gray-100">
                            <h2 className="text-lg font-bold text-[#0F172A]">Edit Task</h2>
                            <button
