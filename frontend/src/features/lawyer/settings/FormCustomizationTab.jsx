...
import { MOCK_FORM_CUSTOMIZATION } from '../data/mockLawyer'

export default function FormCustomizationTab() {
  const [forms, setForms] = useState(MOCK_FORM_CUSTOMIZATION)
            ...
            {selectedForm && (
              <>
                ...
                <div className="mt-6 p-4 border border-dashed border-slate-200 rounded-lg">
                  <button type="button" onClick={() => {}} className="flex items-center gap-2 text-indigo-600 text-sm font-medium hover:underline mb-4">
