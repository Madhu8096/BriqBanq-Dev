...
import { MOCK_ORGANIZATION, MOCK_TEAM_MEMBERS, MOCK_BILLING } from '../data/mockLawyer'
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg border border-slate-200 shadow-sm p-6">
        <div className="flex flex-wrap items-center justify-between gap-4 mb-4">
          ...
          <button type="button" onClick={() => {}} className="px-4 py-2 bg-indigo-600 text-white text-sm font-medium rounded-md hover:bg-indigo-700 flex items-center gap-2">
      ...
      <div className="bg-white rounded-lg border border-slate-200 shadow-sm p-6">
        ...
        <div className="space-y-4">
          <div className="flex flex-wrap items-center justify-between gap-4 py-3 border-b border-slate-100">
            <div>
              <p className="font-medium text-slate-900">{MOCK_BILLING.plan}</p>
              <p className="text-sm text-slate-500">{MOCK_BILLING.price} • {MOCK_BILLING.billingNote}</p>
              <p className="text-sm text-slate-500">Next billing date: {MOCK_BILLING.nextBilling}</p>
            </div>
          ...
          <div className="flex flex-wrap items-center justify-between gap-4 py-3">
            <div>
              ...
              <p className="text-sm text-slate-500">{MOCK_BILLING.paymentMethod} • Expires {MOCK_BILLING.expires}</p>
            </div>
            <button type="button" onClick={() => {}} className="px-4 py-2 border border-slate-300 rounded-md text-sm font-medium text-slate-700 hover:bg-slate-50">
              Update
            </button>
