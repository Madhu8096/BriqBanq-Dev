...
import { useBorrowerProfile } from '../../context/BorrowerProfileContext'
        ...
        <div className="flex items-center gap-0 shrink-0">
          ...
          <div className="flex items-center gap-3 ml-2 pl-2">
            <div className="text-right hidden sm:block">
              <p className="text-sm font-bold text-gray-800 leading-tight">{profile.name}</p>
              <p className="text-xs font-normal text-gray-500 leading-tight">{profile.role}</p>
            </div>
            <NavLink
