        ...
        <div className="space-y-8 max-w-7xl pb-20">
                ...
                {modules.map((mod) => (
                    ...
                    >
                        <div className="flex items-center justify-between mb-6">
                            ...
                            <span className={`px-2 py-1 rounded-md text-[8px] font-black uppercase tracking-widest flex items-center gap-1
                        ...
                        <div>
                            <h4 className="text-lg font-black text-gray-900 tracking-tight">{mod.name}</h4>
                            <p className="text-[10px] text-gray-400 font-bold uppercase tracking-widest mt-1">Version {mod.version}</p>
                        </div>
                        <div className={`mt-4 px-3 py-1 w-fit rounded-lg text-[8px] font-black uppercase tracking-widest
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                ...
                <div className="lg:col-span-8 bg-white rounded-3xl border border-gray-100 p-8 shadow-sm">
                    <h3 className="text-sm font-black text-gray-900 uppercase tracking-widest mb-8">General Configuration</h3>
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="flex items-center justify-between p-6 bg-gray-50/50 border border-gray-100 rounded-2xl">
                            <div>
                                <p className="text-sm font-black text-gray-900">Module Status</p>
                                <p className="text-[10px] text-gray-400 font-bold uppercase tracking-widest mt-1">Module is currently active</p>
                            </div>
                            <button className="px-6 py-2.5 bg-white border border-red-100 text-red-500 text-[10px] font-black uppercase tracking-widest rounded-xl hover:bg-red-50 transition-all">
                                Disable Module
                            </button>
                        </div>
                        ...
                        <div className="grid grid-cols-1 gap-6">
                            <div className="space-y-2">
                                <label className="text-[10px] font-black text-gray-400 uppercase tracking-widest ml-1">Module Name</label>
                            ...
                            <div className="space-y-2">
                                <label className="text-[10px] font-black text-gray-400 uppercase tracking-widest ml-1">Maximum Users</label>
                        ...
                        <div className="flex gap-4 pt-4">
                            <button className="flex-1 py-3 bg-indigo-600 text-white rounded-xl text-xs font-black uppercase tracking-widest shadow-lg shadow-indigo-100 hover:bg-indigo-700 hover:-translate-y-0.5 transition-all">
                                Save Changes
                            </button>
                            <button className="px-8 py-3 bg-white border border-gray-100 rounded-xl text-xs font-black uppercase tracking-widest text-gray-400 hover:text-gray-900 hover:bg-gray-50 transition-all">
                                Reset to Defaults
                            </button>
                        </div>
                    </div>
                ...
                <div className="lg:col-span-4 space-y-8">
                    ...
                    <div className="bg-white rounded-3xl border border-gray-100 p-8 shadow-sm">
                        <h3 className="text-sm font-black text-gray-900 uppercase tracking-widest mb-8">Features</h3>
                        <div className="space-y-3">
                            {['Deals', 'Auctions', 'Contracts', 'Escrow', 'KYC'].map((feature) => (
                                <div key={feature} className="flex items-center justify-between p-4 bg-gray-50/50 border border-gray-100 rounded-2xl group cursor-pointer hover:bg-indigo-50/50 hover:border-indigo-100 transition-all">
                                    <span className="text-xs font-black text-gray-600 uppercase tracking-widest group-hover:text-indigo-600">{feature}</span>
            ...
            <div className="p-10 bg-white rounded-[3rem] border border-gray-100 shadow-sm relative overflow-hidden">
                ...
                <h3 className="text-sm font-black text-gray-900 uppercase tracking-widest mb-10">System-Wide Settings</h3>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-8">
                    {[
                        ...
                        <div key={item.label} className="group flex flex-col items-center text-center">
                            ...
                            <p className="text-[10px] text-gray-400 font-bold uppercase tracking-widest mb-6 leading-relaxed px-4">{item.sub}</p>
                            <button className="w-full py-2.5 bg-gray-50 border border-gray-100 rounded-xl text-[10px] font-black uppercase tracking-widest text-gray-900 hover:bg-white hover:shadow-lg transition-all">
                                Configure
                            </button>
                        </div>
                    ))}
