...
import { Briefcase, Gavel, FileText, DollarSign, Award, Clock, Activity, Plus, TrendingUp, Home, Check } from "lucide-react";

export default function LenderHeroSection() {
    const navigate = useNavigate();

    // Mock stats for the demonstration
    const stats = [
        { label: "Portfolio Value", val: "A$45.6M", sub: "↑ 17.4% this month", color: "text-emerald-400", icon: TrendingUp },
        { label: "Active Loans", val: "23", sub: "5 in MIP process", color: "text-blue-300", icon: Home },
        { label: "Recovery Rate", val: "94.2%", sub: "Industry avg: 89%", color: "text-emerald-400", icon: Check },
        { label: "Avg Days to Settle", val: "45", sub: "Target: 42 days", color: "text-amber-400", icon: Clock }
    ];
