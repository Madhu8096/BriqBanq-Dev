...
const navItems = [
    { label: 'Dashboard', path: '/admin/dashboard', icon: 'dashboard', color: 'text-indigo-600' },
    { label: 'Case Management', path: '/admin/case-management', icon: 'briefcase', color: 'text-blue-500' },
    { label: 'All Deals', path: '/admin/all-deals', icon: 'deal', color: 'text-emerald-600' },
    { label: 'Auction Control', path: '/admin/auction-control', icon: 'auction', color: 'text-violet-600' },
    { label: 'KYC Review Queue', path: '/admin/kyc-review', icon: 'users', color: 'text-amber-600' },
    { label: 'Contracts', path: '/admin/contracts', icon: 'contract', color: 'text-slate-600' },
    { label: 'Escrow Management', path: '/admin/escrow-management', icon: 'escrow', color: 'text-teal-600' },
    { label: 'Document Library', path: '/admin/document-library', icon: 'folder', color: 'text-orange-500' },
    { label: 'Reports & Analytics', path: '/admin/reports-analytics', icon: 'chart', color: 'text-cyan-600' },
    { label: 'E-Signatures', path: '/admin/e-signatures', icon: 'sign', color: 'text-green-600' },
    { label: 'Admin Console', path: '/admin/admin-console', icon: 'shield', color: 'text-red-500' },
