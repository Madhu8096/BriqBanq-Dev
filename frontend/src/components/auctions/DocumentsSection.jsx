          ...
          >
            ...
            <div className="flex gap-3 mt-4 sm:mt-0 w-full sm:w-auto">
              ...
              <a
                href={doc.file || "#"}
                download
                className={`p-2.5 rounded-xl border border-gray-200 bg-white hover:bg-gray-50 hover:border-indigo-200 transition-all active:scale-90 flex items-center justify-center shadow-sm ${!doc.file ? 'pointer-events-none opacity-50' : ''}`}
              >
