  ...
  return (
    <div className="relative group overflow-hidden rounded-3xl shadow-xl">
      ...
      <div className="relative h-[250px] md:h-[350px] lg:h-[450px] w-full">
        <img
          src={currentImage || "https://images.unsplash.com/photo-1560518883-ce09059eeffa?q=80&w=1000"}
        ...
        <div className="absolute top-3 left-3 md:top-5 md:left-5">
          ...
          ) : (deal.status === "Buy Now" || deal.status === "Active" || deal.status === "buy-now") ? (
          ...
          ) : (deal.status === "Coming Soon" || deal.status === "upcoming") ? (
        ...
        <div className="absolute bottom-4 left-4 md:bottom-8 md:left-8 right-4 md:right-auto">
          ...
          <div className="flex items-center gap-4 md:gap-8 pt-3 px-0.5">
            <Spec icon={<BedDouble size={16} />} label={`${deal.bedrooms || deal.propertyDetails?.bedrooms}`} />
            <Spec icon={<Bath size={16} />} label={`${deal.bathrooms || deal.propertyDetails?.bathrooms}`} />
            <Spec icon={<Car size={16} />} label={`${deal.parking || 0}`} />
          </div>
        </div>
