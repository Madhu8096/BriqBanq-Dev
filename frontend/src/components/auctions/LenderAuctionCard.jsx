...
export default function LenderAuctionCard({ auction }) {
    ...
    const isBuyNow = (auction.status === "active" || auction.status === "buy-now") && auction.status !== "upcoming";
    ...
    return (
        ...
        >
            ...
            <div className="relative h-64">
                ...
                <img
                    src={auction.image || "https://images.unsplash.com/photo-1560518883-ce09059eeffa?q=80&w=1000"}
