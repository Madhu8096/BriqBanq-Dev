    ...
    return (
        <div className="max-w-[1200px] mx-auto space-y-12 animate-fade-in-up pb-20">
            ...
            <div className="relative rounded-[2rem] overflow-hidden shadow-xl group h-[400px]">
                {/* Background Image */}
                <img
                    src={deal.image || "https://images.unsplash.com/photo-1545324418-cc1a3fa10c00?auto=format&fit=crop&q=80"}
                    alt="Property"
            ...
            <div>
                ...
                <div className="grid md:grid-cols-2 gap-6 mt-6">
                    <HighlightCard
                        ...
                        desc="Target IRR of 12.4% per annum with monthly interest payments at 8.25% default rate."
                        sub="Historical recovery rate: 87.5%"
                    />
                    <HighlightCard
                        icon={<Shield className="text-blue-500" />}
                        title="Conservative LVR"
                        desc="Loan to Value Ratio of 72.8% provides substantial equity cushion and downside protection."
                        sub="Equity buffer: $270k"
                    />
                    <HighlightCard
                        icon={<MapPin className="text-purple-500" />}
                        title="Prime Location"
                        desc="Located in Potts Point, a highly desirable suburb with strong capital growth history."
                        sub="5-year growth: 42% • Median: $1.15M"
                    />
                    <HighlightCard
                        icon={<AlertTriangle className="text-red-500" />}
                        title="Default Rate Premium"
                        desc="Enhanced return at 8.25% p.a. compared to original rate of 5.75%, providing 2.50% premium."
                        sub="89 days in default • 127 days in arrears"
                    />
                </div>
            </div>
            ...
            <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-6">
                    {deal.images && deal.images.length > 0 ? (
                        ...
                        <img
                            src={deal.image || "https://images.unsplash.com/photo-1512917774080-9991f1c4c750?auto=format&fit=crop&q=80"}
                ...
                <div className="grid lg:grid-cols-2 gap-12 mt-6">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="space-y-3">
                            <StatusItem label="Days in Default" value="89 days" bg="bg-red-50" border="border-red-100" text="text-red-700" />
                            <StatusItem label="Days in Arrears" value="127 days" bg="bg-yellow-50" border="border-yellow-100" text="text-yellow-700" />
                            <StatusItem label="Arrears Amount" value={formatCurrency(24500)} />
                            <StatusItem label="Missed Payments" value="4" />
                        </div>
            ...
            <div>
                ...
                <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm mt-6 grid md:grid-cols-3 gap-8">
                    ...
                    <div className="space-y-4">
                        ...
                        <CompactDetail label="Current Value" value={formatCurrency(1250000)} />
                        <CompactDetail label="Valuation Date" value="15/01/2026" />
                        <CompactDetail label="Valuer" value="Preston Rowe Paterson" />
                        <CompactDetail label="Method" value="Direct Comparison" />
                    </div>
                    <div className="space-y-4">
                        <h5 className="font-bold text-gray-900">Location</h5>
                        <CompactDetail label="Suburb" value="Potts Point" />
                        <CompactDetail label="State" value="NSW" />
                        <CompactDetail label="Postcode" value="2011" />
                        <CompactDetail label="CBD Distance" value="8.5 km" />
                    </div>
                </div>
            </div>
