...
const navItems = [
    ...
    { label: 'Auctions', path: '/lender/auctions', icon: 'auction', color: 'text-emerald-600' },
    { label: 'Contracts', path: '/lender/contracts', icon: 'contract', color: 'text-violet-600' },
    { label: 'Notifications', path: '/lender/notifications', icon: 'bell', color: 'text-rose-500' },
]
...
export default function LenderTopNavBar() {
  ...
  const userRole = user?.role || 'Lender'
