        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden flex flex-col relative">
            ...
            <div className="p-4 sm:p-5 border-b border-gray-50 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                ...
                <div className="flex items-center gap-2 w-full sm:w-auto">
                    ...
                    <button className="flex items-center gap-2 px-3 py-1.5 bg-white border border-gray-200 rounded-lg text-xs font-bold text-[#475569] hover:bg-gray-50 transition-colors shrink-0">
                        <Download size={14} />
                        Export
                    </button>
                </div>
            ...
            <div className="px-5 py-3 bg-gray-50/30 border-b border-gray-50 flex flex-col gap-2">
                <div className="flex flex-wrap items-center gap-3">
                    ...
                    {selectedIds.length > 0 && (
                        <>
                            <button className="flex items-center gap-2 px-3 py-1.5 bg-white border border-gray-200 rounded-lg text-[10px] font-black text-[#475569] hover:bg-gray-50 transition-colors">
                                <Download size={14} />
                                Export
                            </button>
                            <button
                                onClick={() => handleBulkAction('watchlist')}
                                className="flex items-center gap-2 px-4 py-1.5 bg-[#1E40AF] text-white rounded-lg text-[10px] font-black hover:bg-blue-800 transition-all active:scale-95 shadow-sm"
                            >
                                <Eye size={14} />
            ...
            <div className="overflow-x-auto scrollbar-hide">
                <table className="w-full text-left border-collapse">
                    <thead className="bg-[#F8FAFC]/50 text-[#64748B] text-[10px] font-extrabold uppercase tracking-widest border-b border-gray-100">
                        <tr>
                            <th className="pl-5 pr-3 py-4 w-10">
                                <input
                                    type="checkbox"
                                    className="rounded border-gray-300 accent-indigo-600 cursor-pointer w-4 h-4"
                                    checked={selectedIds.length === paginatedInvestments.length && paginatedInvestments.length > 0}
                                ...
                                >
                                    ...
                                    <td className="px-3 py-4 whitespace-nowrap">
                                        <button
                                            ...
                                            className="text-indigo-600 font-black text-[11px] hover:underline"
                                        >
                                            {deal.id}
                                        </button>
                                    </td>
                                    <td className="px-3 py-4">
                                        <div className="min-w-[140px]">
                                            ...
                                            <p className="text-gray-400 text-[9px] font-bold mt-1 uppercase tracking-tight">
                                    ...
                                    <td className="px-3 py-4">
                                        <div className="w-20">
                                            <div className="flex items-center gap-2">
                                                ...
                                                <span className="text-gray-400 text-[9px] font-bold">{deal.lvr || 0}%</span>
                                            </div>
                                        </div>
                                    </td>
                                    <td className="px-3 py-4 text-center">
                                        <span
                                            className={`inline-flex px-2 py-0.5 rounded-lg text-[9px] font-black uppercase tracking-tighter ${deal.status === "Live Auction"
                                    ...
                                    <td className="pl-3 pr-5 py-4">
                                        <div className="flex items-center gap-1.5 justify-end">
                                            ...
                                            <button
                                                onClick={() => handleBid(deal)}
                                                className="p-1.5 bg-[#1E40AF] text-white rounded-lg hover:bg-indigo-900 transition-all shadow shadow-indigo-100 active:scale-95"
                                            >
                                                <Gavel size={16} />
                                            </button>
                                        </div>
