...
export default function InvestorAlerts({ investments = [] }) {
    ...
    const targetSettlement = upcomingSettlements.length > 0
        ? upcomingSettlements[0]
        : { id: "MIP-2026-003", propertyData: { address: "Upcoming Settlement" }, expectedReturn: 142000, currentBid: 1420000 };

    const settlementId = targetSettlement.id;
    const settlementReturn = ((targetSettlement.currentBid || targetSettlement.expectedReturn || 1420000) * 0.1).toLocaleString();
